// ===============================================
// SULO FITNESS v2.0 - APLICACIÓN COMPLETA
// ORDEN DE CLASES CORREGIDO para evitar errores de inicialización
// ===============================================

// ===== CLASES DE SOPORTE (PRIMERO) =====
class BaseModule {
...
class WorkoutModule extends BaseModule {
    ...
    generateDayExercises(sessionType, dayIndex) {
        if (sessionType === 'entrenamiento') {
            const isUpperDay = dayIndex === 0 || dayIndex === 4;
            ...
            <div style="animation: fadeIn 0.6s ease-out;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-bottom: 40px;">
                    ${Object.values(this.weeklyPlan).map(day => {
                        ...
                        return `
                            <div class="macro-card day-card" style="cursor: pointer; text-align: center; transition: all 0.3s ease; border: 3px solid ${day.completed ? '#10b981' : session.color}40; position: relative;" onclick="app.workoutModule.openDayDetail('${day.date}')">
            ...
            <div style="animation: fadeIn 0.6s ease-out; max-width: 1000px; margin: 0 auto;">
                ...
                <div class="grid-2">
                    ${preferences.nutritionEnabled ? `
                        <div class="macro-card" style="cursor: pointer; transition: transform 0.3s ease;" onclick="app.navigate('diaria')">
                ...
                <div style="text-align: center; margin-top: 40px;">
                    <button onclick="app.navigate('diaria')" class="btn-primary" style="font-size: 18px; padding: 16px 32px; margin: 8px;">
                        📅 Comenzar Hoy
                    </button>
